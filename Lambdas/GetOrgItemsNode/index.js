...
exports.handler = async (event, context) => {
    ...
    try {
        ...
        // Execute query
        const sql = 'select c.name as CharityName, item.name as ItemName, c.id as CharityId, item.id as ItemId from charity c join charity_item i on c.id = i.charity_id inner join item on item.id = i.item_id order by 1,2';
