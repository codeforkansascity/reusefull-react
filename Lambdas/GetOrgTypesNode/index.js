...
exports.handler = async (event, context) => {
    ...
    try {
        ...
        // Execute query
        const sql = 'select c.name as CharityName, types.name as TypeName, c.id as CharityId, types.id as TypeId from charity c join charity_type i on c.id = i.charity_id inner join types on types.id = i.type_id order by 1,2';
